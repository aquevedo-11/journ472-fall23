...
A2.The summer months tend to see an increase in number of 911 calls with each county reaching peak call volume in August. Each county seemed to have different times when call volumes were lowest - generally, Cecil and Allegany counties were lowest in December/January while Carroll was lowest in April.
314 GROVE NECK RD EARLEVILLE, MD in Cecil County had the most calls (15 total). This is one of two Recovery Centers of America locations in Maryland.
