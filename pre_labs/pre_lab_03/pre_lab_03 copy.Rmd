...
**Answer** The message alerts us to parsing issues and recommends we run a problem function to review the cause of the issue. The script wa sunable to find the issue in the first 10 rows.
...
**Answer** I can't figure this out...I have failed you.
