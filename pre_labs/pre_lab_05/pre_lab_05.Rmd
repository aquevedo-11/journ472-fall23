...
**Answer** R reads the first row of data as column names.
...
**Task** Load the data without headers by running the codeblock below. What problems remain? **Answer** The first row is no longer reading data as column names; however, the column names do not accurately describe the data reflected in each (region/subdivision, years).
...
**Answer** We need to remove the line of periods/dots after each jurisdiction name.
