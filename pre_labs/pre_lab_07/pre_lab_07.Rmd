...
**Answer** Nevada had the largest population growth - 35%.
...
**Answer** Howard County, Maryland - average income is about 120 thousand doll hairs (dollars). 
...
**Task** Run the following codeblock to create a chart showing the margin of error for each county. The current headline isn't very descriptive of the data. What should it be? **Answer** Estimated median household income in Maryland by county.
...
**Answer** No, there is overlap, meaning the margin of error could displace any variance.

Is the difference between Howard and everyone else significant? 
**Answer** Yes, there is no overlap, meaning even with a margin of error, Howard's average income is significantly hihger than other that of other counties.
...
**Answer** Baltimore City, Allegany County, and Calvert County saw the largest increases in median income. There were no counties with median incomes that fell, however Caroline County saw just a single digit increase compared to all other counties.
...
**Answer** At approximately what median household income do we start to start to see over 50% of high school graduates enrolled in college? Margin or error and outliers (Bard High School in Baltimore City 21216 has a estimated average household income of 40 thousand doll hairs).
...
**Answer** There are 50 schools with more than 60% of graduates enrolled in college and 72 with fewer than 40% of graduates enrolled in college.
...
**Answer** What is the percentage of high schools per county with over half of high school graduates enrolled in college? Do results align with expectations as it relates to average income (Howard County should have the highest percentage, Garrett County should have the lowest).
