...
Here? - https://datawrapper.dwcdn.net/yqnNZ/1/
...
**Answer** The map only includes Maryland now; the rest of the US is ommitted. Also, I'm not quite sure what's causing the error on my end, but Saint Mary's County does not appear once I enable the "hide regions without data" feature either. I tried manually updating the name when uploading my data to Datawrapper (step 2), but that didn't change anything. 
...
**Answer** County names and its percentage of total votes cast for Wes Moore are visible when the user's mouse is hovered over it (example: PG County, 89.10%).
...
Tada: https://datawrapper.dwcdn.net/wr4yd/1/
