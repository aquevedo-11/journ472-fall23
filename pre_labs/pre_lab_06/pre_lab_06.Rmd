...
**Task** Load the four CSV population estimate files. Do they have the same column structure? **Answer** Initially, no, the four files do not have the same column structure. File county_voters_2022 has a lowercase "total" column. 
...
**Answer** While the number of registered voters has increased over time, the registration of democratic voters has jumped over 18k since 2016. It's resulted in a county flip from Republican majority to Democratic majority.
...
**Answer** The info provided breaks down the number of people per racial group (Asian, Black, etc) as well as the total population per county over 18 years old (eligible to vote).
...
**Answer** The percentage with highest 18+ Black population is Prince George's County at 60.9% with 77.1% of voters registered as Democrats.
...
**Answer** The percentage with highest 18+ Asian population is Howard County at 19.4% with 52.6% of voters registered as Democrats. This is a drastic drop from the share of Black adults in Maryland (1/5 at most compared to 3/5).
...
**Answer** It is a number (dbl) datatype.
...
**Answer** ZCTA5N is now a character datatype (chr).
