...
**Answer** Nothing, womp womp. We're given a blank space (canvas) to work with going forward.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**A bar chart has been created with months on the x-axis and number of calls on the y-axis.
...
**Answer** The bar chart is now ordered in ascending order from months with fewest calls to months with most calls.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? 
**Answer** The axis have flipped - x is now y, y is now x.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? 
**Answer** The background is white rather than grey. 
...
**Answer** The color scheme has changed - the background is blue, the bars and text are grey and black.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? 
**Answer** The chart now has a title and both axis have labels describing content on each (months, total 911 calls).
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** A new dataframe has been created grouping number of calls make per date.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** There's a pretty noisy line chart being presented. Most dates have call volumes between 5 and 15 calls per date.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The x-axis is now labeled per date occurance rather than by month (though not readable).
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The date labels on the x-axis are more legible - though not completely legible - having been rotated 45 degrees so the text is less cramped.
