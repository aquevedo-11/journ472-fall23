...
**Answer** The two columns in the table located on the MD DOE's website have been extracted and saved into R. There is a character date column and character press release column. 
...
**Answer** If possible, I'd like to create a category column. Maybe by string detecting things like "meeting", "awards", "named".
...
**Answer** There are at least three types of ul tags.
...
**Answer** The output contains a numbered list of li tags with just the title listed within quotation marks rather than the full html code.
...
**Answer**The elements in the previous output have been formatted into a single column df. The column is titled "value".
