...
**Answer**Dataframe contains 999 press releases from Sen. Cardin's office. The data is categorized by date, title, URL,  and text.
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer** A df containing a list of all words found in in press releases.
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer** The graphic shows a chart ranking the most common words found in Cardin's press releases. Not very interesting a first - it's mostly made up of articles and pronouns.
...
**Answer** In line with national events at the time, 2021's most common words were focused around healthcare and covid-19.In 2022, the top words were focused around communities and rebuilding (funding, support) after the economic, educational, etc devestation the pandemic brought about. In 2023, the word women broke the top 5 despite not being present in the top 10 at all the previous two years. Fire was also a new keyword.
