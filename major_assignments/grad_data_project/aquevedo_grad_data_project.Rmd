...
final_3_gg <- inner_join(port_of_bmore_gg, port_of_nynj_gg, by = "year") %>%
  ...
  #ggplot(big_3_gg) +
  #geom_point(aes(x = Year, y = `Port of VA`, color = "Port of VA")) +
  #geom_point(aes(x = Year, y = `Port of NY-NJ`, color = "Port of NY-NJ")) +
  #geom_point(aes(x = Year, y = `Port of Baltimore`, color = "Port of Baltimore")) +
  #labs(title = "Atlantic Coast Volumes",
   #    x = "Year",
    #   y = "Port") +
  #scale_x_continuous(breaks = seq (2018, 2022, by = 1)) +
  #scale_color_manual(values = c("Port of VA" = "blue", "Port of NY-NJ" = "yellow", "Port of Baltimore" = "orange")) +
  #theme_minimal()
```
