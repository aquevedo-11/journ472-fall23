...
ggplot(restructured_final_3, aes(x = year, y = value, color = port)) +
...
#       y = "port") +
#  scale_x_continuous(breaks = seq(2018, 2022, by = 1)) +
#  scale_color_manual(name = "ports", values = c("Virginia" = "blue", "NY_NJ" = "yellow", "Baltimore" = "orange")) +
#  theme_minimal()
