...
Non-MD related - I'm interested in what infrastructure is being/has been put in place at NY-NJ now that they are seeing a sustained increase in ocean freight (new container warehouses, increase in personel, etc).

**Known Errors in Data**

The TEU numbers reported by the USDOT (my baseline) did not match the numbers recevied by individual port authorities. I did some digging and initially believed certain totals included empty containers rather than just loaded import/export containers; however, after manually subtracting empty container numbers, they still did not match but were close enough.
