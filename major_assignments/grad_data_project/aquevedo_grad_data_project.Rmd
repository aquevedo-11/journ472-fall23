...
port_of_nynj <- read_csv("data/port_of_nynj_2019_2022.csv") |> clean_names()
...
US_ports_data_big_3 |>
  ...
  labs(
    title="Annual Atlantic Coast Ports TEU Volumes",
    x = "Port",
    y = "Total TEUs",
...
port_of_va_gg <- port_of_va |> rename(count_type = x1) |> rename(load_type = x2) |>
  select(count_type, load_type, x2019, x2020, x2021, x2022) |>
